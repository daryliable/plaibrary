              ...
              <div class="col-6">
                 ...
                 <div class="form-row">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" style="margin-right: 10px" value="{{$user->profile->gender ?? ''}}" disabled>

                    <div class="input-group-prepend">
                          <span class="input-group-text">Civil Status</span>
                    </div>
                    <input class="form-control" value="{{$user->profile->civil ?? ' '}}" disabled>
...
<!-- Tunga -->
          ...
          <div class="tab-pane fade" id="account" role="tabpanel" aria-labelledby="account-tab">
              ...
              <form  action="{{ route('librarian.profile.updatepassword')}}" enctype="" method="post">
              @csrf
                 @method('PATCH')
                <br>
                ...
                <div class="input-group col-6">
                  <div class="input-group-prepend">
                    ...
                    <input name="email" type="text" class="form-control" value="{{ old('name') ?? $user->email  ?? ''}}" required> 
                  </div>
                </div><br>
                <div class="form-row">
                <div class="input-group col-6">
