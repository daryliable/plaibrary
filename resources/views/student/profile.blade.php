    ...
    <section id="schedules" class="schedule section-padding">
      ...
      <div class="container">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="book-tab" data-toggle="tab" href="#book" role="tab" aria-controls="book" aria-selected="false">Book Borrowed</a>
                  </li>
                </ul>
              ...
              <div class="col-6">
                 ...
                 <div class="form-row">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="" value="{{$student->name}}" disabled>
                  </div>
                  </div>
